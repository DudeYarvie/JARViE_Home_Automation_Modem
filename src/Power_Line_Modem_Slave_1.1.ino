...
Releases: 
            1.0 - Intial release
            1.1 - Commented out line 112 that prints received msg buffer and checksum
                  because it was printing debug message while other messages were being received.
**/
...
char *recv_cmd(){
  ...
  //Serial.print(buf);                                             //Print buffer for debugging                                    
